...
using static LevelGeneration.ExpandingAndSimplifying;
...
public class LevelGeneration : MonoBehaviour
{
    ...
    public static class ExpandingAndSimplifying
    {
        ...
        // Need AdditionAndSubtraction Phase Info since Expandion and Simplifying is just Addition/Subtraction Fractions expanded/simplified
        {
            ...
            NumeratorPhase numeratorPhase = GetRandomItem(Weights.numeratorPhaseProperbilityWeightmap);
            DenominatorPhase denominatorPhase = GetRandomItem(Weights.denominatorPhaseProperbilityWeightmap);
    ...
    public static class Multiplication
    {
        ...
        internal static Fraction generateEncounterFraction(bool make_first_value_the_numerator)
        {
            ...
            ChallangeSet set = GetRandomItem(Weights.challangeSetProperbilityWeightmap);
            switch (set)
            {
